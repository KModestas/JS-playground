...
// 1. [Timer phase] - processed first, however if race condition happens then setImmediate below may be logged first
setTimeout(() => { 
...
// 6. this I/O call back is run
  ...
  // 8. This is the only thing left to execute while the Promise is waiting so it will always log second to last
