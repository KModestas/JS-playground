...
// when the event loop kicks in after executing your code, it starts with timers phase so setTimeout is called before setImmediate.
...
// NOTE: in eventloop.js, setTimeout 0 seems to always run before setImmediate globally because the microtasks seem to give setTimeout enough time to be added to the timer callback before it enters the [Timer Phase] 